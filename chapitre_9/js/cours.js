...
ajaxGet("https://oc-jswebsrv.herokuapp.com/api/articles", function (reponse) {
  ...
  var articles = JSON.parse(reponse);
  articles.forEach(function (article) {
>>>>>>> ab2376da2adeeec2ce90e1b32be5a865c1f284c0
...
ajaxGet("http://api.wunderground.com/api/50a65432f17cf542/conditions/q/France/Lyon.json", function(reponse){
  ...
  var température = meteo.current_observation.temp_c;
  ...
  conditionsElt.textContent = "Il fait actuelement " + température + " C et l'humidité est de " + humidite;
